...
python3 setup.py install --user --targets=caffe
```

## 使用方式

转换器按输入模型格式主要分为两种：
1. 使用megengine [dump](https://megengine.org.cn/doc/stable/zh/user-guide/model-development/jit/dump.html#dump) 出来的序列化模型，这类模型的转换器以 `mge_to` 命名
